...
namespace ExpenseTracker.Services
{
    public static class ApplicationService
    {
        ...
        void MonthlyBudgetComparison(decimal budget, decimal totalExpenses) // how should i handle this budget serivce?
        {
        ...
        int MonthConverter(string month)// do I make a month converter service? 
        {
